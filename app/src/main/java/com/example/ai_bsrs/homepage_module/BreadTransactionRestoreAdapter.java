...
public class BreadTransactionRestoreAdapter extends RecyclerView.Adapter<BreadTransactionRestoreAdapter.ViewHolder> {
    ...
    public BreadTransactionRestoreAdapter(Context ctx, ArrayList<Bread>mBreadList) {
    ...
    @NonNull
    @Override
    public BreadTransactionRestoreAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.breadscanned_list,parent,false);
        return new BreadTransactionRestoreAdapter.ViewHolder(view, mListener);
    }


    @Override
    public void onBindViewHolder(@NonNull final BreadTransactionRestoreAdapter.ViewHolder holder, int position) {
